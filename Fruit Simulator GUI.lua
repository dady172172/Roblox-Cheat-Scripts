...
----  ----
sectionAutoFarm:addToggle("Attack", false, function(bool)
...
sectionAutoFarm:addToggle("Teleport to fruit", false, function(bool)
    kVars.boolttf = bool
...
sectionAutoFarm:addButton("Open Shop", function()
    firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart,game:GetService("Workspace").GameplayAssets.ShopEnterance.Hit,0)
    wait()
    firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart,game:GetService("Workspace").GameplayAssets.ShopEnterance.Hit,1)
 end)
