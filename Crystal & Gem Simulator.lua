...
---- vars ----
kVars = {}
kVars.WindowName = "Crystal & Gem Simulator GUI"
...
function fGems()
    spawn(function()      
        while kVars.boolGems do
            wait()
            for i,v in pairs(game:GetService("Workspace").DropContainers:GetDescendants()) do
                if v.name == "TouchInterest" then                       
                        if kVars.boolGems == false then break end
                        pcall(function() v.Parent.CanCollide = false end)   
                        pcall(function() v.Parent.CFrame = kVars.hrp.CFrame end)
                        wait(.1)
                end
            end
        end  
...
sectionFarm:Create("Button", "Unlock Areas", function()
    game:GetService("Workspace").UnlockDoors:Destroy()
end,{animated = true})

sectionFarm:Create("Button", "Delete Barriers", function()
