--[[
Game : https://www.roblox.com/games/6647511053
...
---- Variables ----
kVars = {}
kVars.WindowName = "Coin Collecting Simulator by Starlight Games GUI"
...
function fCollect()
    spawn(function()
        while kVars.boolCollect do
            ...
            game:GetService("ReplicatedStorage").Events.RemoteEvent:FireServer("Collect", area)
        end
    end)
end
