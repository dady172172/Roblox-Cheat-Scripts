--[[
Game : https://www.roblox.com/games/12242680183
...
---- vars ----
kVars = {}
kVars.WindowName = "Every Second You Get +1 Flight GUI"
...
function fWin()
    spawn(function()
        while kVars.boolWin do
            ...
            local a = nil
            local last = 0
            for i,v in pairs(game:GetService("Workspace").WinParts:GetChildren()) do
                if v.WinsReward.Value > last then
                    a = v
                    last = v.WinsReward.Value
                end
            end
            if (kVars.hrp.Position - a.Position).Magnitude > 4 then
                kVars.hrp.CFrame = a.CFrame
            end
        end
    end)
end
...
--[[
getgenv().fuckyou = false

while getgenv().fuckyou do
    task.wait()
local args = {
    [1] = "Uranus Egg"
}
...
game:GetService("ReplicatedStorage").RemoteEvents.CraftAll:FireServer()
...
end,{min = 0, max = 99999, default = kVars.humanoid.jumpHeight, precise = false, changablevalue = true})
