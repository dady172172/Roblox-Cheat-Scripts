--[[
Game : https://www.roblox.com/games/1502601752
...
---- vars ----
kVars = {}
kVars.WindowName = "Rabbit Simulator 2 GUI"
...
sectionFarm:Create("Toggle", "Carrots",function(bool)
    kVars.boolCarrots = bool
    if bool then
        fCarrots()
    end
end,{default = kVars.boolCarrots})
...
function fCarrots()
    spawn(function()
        while kVars.boolCarrots do
            wait()
            game:GetService("Players").LocalPlayer.Character.Carrot.E:FireServer()

            if kVars.boolRebirth and game:GetService("Players").LocalPlayer.leaderstats.Carrots.Value >= 100000 then
                wait()
